...
CMD mkfs.mse -f -c /var/lib/mse/mse.conf && service hitch start && /usr/sbin/varnishd -F -a :8080 -s mse,/var/lib/mse/mse.conf -p vsl_mask=+Hash -f /etc/varnish/default.vcl -p http_gzip_support=off
